    ...
    class UploadHandler
    {
        ...
        protected function get_upload_path($file_name = null, $version = null)
        {
            ...
            if (empty($version)) {
               ...
               // echo "==".$this->options['image_versions'][$version]['path_salt']."===".$file_name;
                if($this->options['image_versions'][$version]['path_salt'] && $file_name !=null){
                    $file_name = $this->options['image_versions'][$version]['path_salt'].$file_name;
                }
                if ($version_dir) {
            ...
            . ($file_name ==null ? $file_name : $version_path . $this->options["path_salt"] . $file_name);
        }
        ...
        protected function get_scaled_image_file_paths($file_name, $version)
        {
            ...
            if (!empty($version)) {
                ...
                $version_dir = dirname($new_file_path);
